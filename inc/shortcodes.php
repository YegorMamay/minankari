...
if (!function_exists('signature_shortcode')) {
    function signature_shortcode()
    {
        echo '<div class="signature">
            <div class="signature__sign-wrapper">
                <img src="' . get_template_directory_uri() . '/assets/img/signature/sign.png" alt="" title="" />
            </div>
            <div class="signature__avatar-wrapper">
                <div class="signature__avatar-wrapper__image">
                    <img src="' . get_template_directory_uri() . '/assets/img/signature/avatar.png" alt="" title="" />
                </div>
                <div class="signature__avatar-wrapper__text">
                    <span>Елена К.</span>
                    <small>Основатель «Minankari»</small>
                </div>
            </div>
        </div>';
    }
