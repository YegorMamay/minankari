...
function bw_reviews_addition_callback($post, $meta_info)
{
    ...
    <p class="meta-options">
        ...
        <br>
        <input type="checkbox" name="review-display" id="review-display" value="1" <?php checked($review['display'], '1'); ?>>
        <?php echo esc_html('Display review on Home page'); ?>
    </p>
    <p class="meta-options">
        <label for="review-vk"><b><?php echo esc_html('VK URL'); ?></b></label>
        <br>
        <input type="url" name="review-vk" id="review-vk" placeholder="https://vk.com" size="30" value="<?php echo esc_attr($review['vk']); ?>">
    </p>
    <p class="meta-options">
        <label for="review-youtube"><b><?php echo esc_html('YouTube URL'); ?></b></label>
        <br>
        <input type="url" name="review-youtube" id="review-youtube" placeholder="https://www.youtube.com" size="30" value="<?php echo esc_attr($review['youtube']); ?>">
    </p>
    <p class="meta-options">
        <label for="review-twitter"><b><?php echo esc_html('Twitter URL'); ?></b></label>
        <br>
        <input type="url" name="review-twitter" id="review-twitter" placeholder="https://twitter.com" size="30" value="<?php echo esc_attr($review['twitter']); ?>">
    </p>
    <p class="meta-options">
        <label for="review-facebook"><b><?php echo esc_html('Facebook URL'); ?></b></label>
        <br>
        <input type="url" name="review-facebook" id="review-facebook" placeholder="https://www.facebook.com" size="30" value="<?php echo esc_attr($review['facebook']); ?>">
    </p>
    <p class="meta-options">
        <label for="review-linkedin"><b><?php echo esc_html('LinkedIn URL'); ?></b></label>
        <br>
        <input type="url" name="review-linkedin" id="review-linkedin" placeholder="https://www.linkedin.com" size="30" value="<?php echo esc_attr($review['linkedin']); ?>">
    </p>
    <p class="meta-options">
        <label for="review-instagram"><b><?php echo esc_html('Instagram URL'); ?></b></label>
        <br>
        <input type="url" name="review-instagram" id="review-instagram" placeholder="https://www.instagram.com" size="30" value="<?php echo esc_attr($review['instagram']); ?>">
    </p>
    <p class="meta-options">
        <label for="review-google-plus"><b><?php echo esc_html('Google Plus URL'); ?></b></label>
        <br>
        <input type="url" name="review-google-plus" id="review-google-plus" placeholder="https://plus.google.com" size="30" value="<?php echo esc_attr($review['google-plus']); ?>">
    </p>
    <p class="meta-options">
        <label for="review-odnoklassniki"><b><?php echo esc_html('Odnoklassniki URL'); ?></b></label>
        <br>
        <input type="url" name="review-odnoklassniki" id="review-odnoklassniki" placeholder="https://ok.ru" size="30" value="<?php echo esc_attr($review['odnoklassniki']); ?>">
    </p>
<?php }
    ...
    $meta_boxes[] = array(
        ...
        'fields'  => array(
            [
                'id' => 'about-left',
                'type' => 'wysiwyg',
                'name' => 'О компании, левая колонка'
            ], [
                'id' => 'about-right',
                'type' => 'wysiwyg',
                'name' => 'О компании, правая колонка'
            ]
        ),
    );
    return $meta_boxes;
