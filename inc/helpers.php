...
if (!function_exists('woocommerce_cart')) {
    ...
    function woocommerce_cart()
    {
        ...
        $link = sprintf(
            '<a class="cart-contents" href="%s" title="%s">%s</a>',
            $cart_url,
            $title,
            $count
        );
...
if (!function_exists('get_last_added_products')) {
...
if (!function_exists('get_products_on_sale')) {
    function get_products_on_sale()
    {
        ...
        foreach ($products as $key => $product) {
            $products[$key] = wc_get_product($product->ID);
        }
        return $products;
    }
}

if (!function_exists('the_product_card')) {
    function the_product_card($product)
    {
        $on_sale_html = '';
        $price_html = '';
        ...
        <div class="product-item">
            ...
            <a href="' . get_the_permalink($product->get_id()) . '" class="btn">' . __('Подробнее', 'brainworks') . '</a>
        </div>
    </div>';
    }
}
